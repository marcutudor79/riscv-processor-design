...
the assembly code from the C source:

\begin{framed}
riscv64-linux-gnu-gcc -g -O0 -mcmodel=medlow -mabi=ilp32 -march=rv32im -Wall -c -o se201-prog.o se201-prog.c
\end{framed}

\subsection{Comparison between the Generated Assembly and the Provided Program}

Generated Assembly Instructions:
\begin{lstlisting}[numbers=left, stepnumber=1, numbersep=5pt]
    addv:
.LFB1:
	.loc 1 14 1
	.cfi_startproc
